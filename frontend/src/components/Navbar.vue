        ...
        <ul class="navbar-nav ms-auto align-items-center">
          ...
          <template v-if="authStore.isAuthenticated">
            ...
            <li v-if="authStore.user?.role === 'admin'" class="nav-item">
              <RouterLink class="nav-link nav-link-custom text-dark px-3 fw-semibold" to="/admin/dashboard">Dashboard</RouterLink>
            </li>
            <li v-if="authStore.user?.role === 'admin'" class="nav-item">
              <RouterLink class="nav-link nav-link-custom text-dark px-3 fw-semibold" to="/admin/companies">Companies</RouterLink>
            </li>
            <li v-if="authStore.user?.role === 'admin'" class="nav-item">
              <RouterLink class="nav-link nav-link-custom text-dark px-3 fw-semibold" to="/admin/students">Students</RouterLink>
            </li>
            <li v-if="authStore.user?.role === 'admin'" class="nav-item">
              <RouterLink class="nav-link nav-link-custom text-dark px-3 fw-semibold" to="/admin/drives">Drives</RouterLink>
            </li>
            ...
            <!-- Student Links -->
            <li v-if="authStore.user?.role !== 'admin' && authStore.user?.role !== 'company'" class="nav-item">
              <RouterLink class="nav-link nav-link-custom text-dark px-3 fw-semibold" to="/student/dashboard">Browse Jobs</RouterLink>
            </li>
            <li v-if="authStore.user?.role !== 'admin' && authStore.user?.role !== 'company'" class="nav-item">
              <RouterLink class="nav-link nav-link-custom text-dark px-3 fw-semibold" to="/student/applications">My Applications</RouterLink>
            </li>
            <li v-if="authStore.user?.role !== 'admin' && authStore.user?.role !== 'company'" class="nav-item">
              <RouterLink class="nav-link nav-link-custom text-dark px-3 fw-semibold" to="/student/history">Applications History</RouterLink>
            </li>
            ...
            <li class="nav-item ms-lg-3">
              <button @click="handleLogout" class="btn btn-outline-danger logout-btn fw-bold px-4 rounded-pill btn-sm shadow-sm">
                Logout
              </button>
            </li>
          </template>
          ...
          <template v-else>
            ...
            <li class="nav-item ms-lg-3">
              <RouterLink to="/login" class="btn btn-link text-dark text-decoration-none fw-bold px-3">Log In</RouterLink>
            </li>
            <li class="nav-item ms-lg-2">
              <RouterLink to="/register" class="btn btn-primary fw-bold px-4 rounded-pill shadow-sm">Get Started</RouterLink>
            </li>
          </template>
