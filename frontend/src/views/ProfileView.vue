...
const updateProfile = async () => {
  ...
  try {
    ...
    if (authStore.userRole === 'student' && form.resume_link?.trim()) {
    ...
    // Clear sensitive/temporary fields
    form.npassword = ''
    form.cpassword = ''
    form.resume_link = ''
            ...
            <form @submit.prevent="updateProfile">
              <div class="row g-4">
                ...
                <div class="col-12">
                  ...
                  <div class="row g-3">
                    <div :class="authStore.userRole === 'student' ? 'col-md-6' : 'col-12'">
                      <label class="form-label small fw-bold text-muted">Full Name</label>
                      <input v-model="form.name" type="text" class="form-control bg-light border-0 py-2" required>
                    </div>
                    <div :class="authStore.userRole === 'student' ? 'col-md-6' : 'col-12'">
                      <label class="form-label small fw-bold text-muted">username</label>
                      <input v-model="form.username" type="text" class="form-control bg-light border-0 py-2" required disabled>
                    </div>
                    
                    <div v-if="authStore.userRole === 'student'" class="col-md-6">
